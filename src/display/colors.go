...
// Convert a uint color (0-255) to a float representation of that same color
// (0.0 - 1.0)
...
// Separate the red, green, blue and alpha channels from an 8 character hex
// value and return each one as a uint.
...
// Separate the red, green, blue and alpha channels from a 6 character hex
// value and return each channel as a float64 (0-255 is represented as a value
// from zero to 1).
...
// Separate the red, green and blue channels from a 6 character hex value and
// return each one as a uint.
...
// Separate the red, green and blue channels from a 6 character hex value and
// return each channel as a float64 (0-255 is represented as a value from zero
// to 1).
