...
func createDisplayableTree() (Displayable, []Displayable) {
	...
	root = TestComponent(ctx.New(), Children(func(c Context) {
...
func createStubApp() (Displayable, []Displayable) {
	...
	root = TestComponent(ctx.New(), ID("root"), Width(800), Height(600), Children(func(c Context) {
...
func createTwoBoxes() (Displayable, Displayable) {
	...
	root = TestComponent(ctx.New(), ID("root"), Padding(10), Width(100), Height(110), Children(func(c Context) {
...
func TestLayout(t *testing.T) {
	...
	t.Run("GetFlexibleChildren", func(t *testing.T) {
		t.Run("Scales flex children", func(t *testing.T) {
			...
			HBox(ctx.New(), ID("root"), Padding(5), Width(100), Height(110), Children(func(c Context) {
	...
	t.Run("Spread remainder", func(t *testing.T) {
		...
		HBox(ctx.New(), Width(152), Children(func(c Context) {
	...
	t.Run("Basic, nested layout", func(t *testing.T) {
		...
		VBox(ctx.New(), ID("root"), Width(100), Height(300), Children(func(c Context) {
	...
	t.Run("Nested, flexible controls should expand", func(t *testing.T) {
		root := Box(ctx.New(), ID("root"), Width(100), Children(func(c Context) {
	...
	t.Run("Gutter is supported", func(t *testing.T) {
		root := VBox(ctx.New(), Padding(5), Gutter(10), Children(func(c Context) {
	...
	t.Run("Layouts with larger children", func(t *testing.T) {
		t.Run("Does not shrink larger parent", func(t *testing.T) {
			root := Box(ctx.New(), Width(50), Height(50), Children(func(c Context) {
		...
		t.Run("Vertical", func(t *testing.T) {
			root := VBox(ctx.New(), Gutter(5), Padding(5), Children(func(c Context) {
		...
		t.Run("Horizontal", func(t *testing.T) {
			root := HBox(ctx.New(), Gutter(5), Padding(5), Children(func(c Context) {
				Box(c, Width(20), Height(20))
				Box(c, Width(20), Height(20))
				Box(c, Width(20), Height(20))
				Box(c, Width(20), Height(20))
	...
	t.Run("Align center", func(t *testing.T) {
		var one, two, three Displayable
		root := Box(ctx.New(), HAlign(AlignCenter), VAlign(AlignCenter), Padding(5), Width(60), Height(60), Children(func(c Context) {
	...
	t.Run("Align last", func(t *testing.T) {
		var one, two, three Displayable
		root := Box(ctx.New(), HAlign(AlignRight), VAlign(AlignBottom), Padding(5), Width(60), Height(60), Children(func(c Context) {
			// This should be positioned in the center even though three blew out.
			one = Box(c, Width(75), Height(75))
			two = Box(c, Width(50), Height(50))
			// Three will blow out the assigned parent dimensions.
	...
	t.Run("Distribute space after limit", func(t *testing.T) {
		var one, two, three Displayable
		VBox(ctx.New(), Width(100), Height(100), Children(func(c Context) {
