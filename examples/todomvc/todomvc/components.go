...
func CreateTraits(b Builder, model TodoModel) {
	...
	Trait(b, ".header-h1",
		...
		FontSize(100),
		HAlign(AlignCenter),
		FontColor(0xaf2f2fff)) // color.RGBA{175, 47, 47, 0.15}
...
func CreateTodoHandler(model TodoModel) EventHandler {
	return func(e Event) {
...
func Create(c clock.Clock) (Displayable, error) {
